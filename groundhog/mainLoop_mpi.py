...
class MainLoop_mpi(object):
    ...
    def train_batches_master(self,train_context):
        n_batches = self.state['nBatch_per_step']
    ...
    def after_train_master(self,train_context):
        ...
        self.state['wholetime'] = float(time.time() - self.start_time)
    ...
    def before_train_worker(self,workerID):
        train_context = {}
    ...
    def train_batches_worker(self,train_context):
